...
<head>
   ...
   <link href="https://cdn.jsdelivr.net/npm/F@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
   <style>
       .form-group {
           display: flex;
           align-items: center;
...
<body class="d-flex justify-content-center align-items-center vh-100 bg-light">
   ...
   <script type="text/javascript">
       const updateText = (event, id, input) => {
           if (event.key === 'Enter') {
               input.readOnly = true;
               const url = '/JavaWebTodoList/todolist/update/?id=' + id + '&text=' + encodeURIComponent(input.value); //因為get過去後可能會有中文所以要用encode可以讓亂碼變回中文
               location.href = url;
           }
       };
   </script>
