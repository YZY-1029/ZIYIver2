...
public class RoomRestController {
	...
	throw new RoomException("新稱失敗" + bindingResult.getAllErrors().get(0).getDefaultMessage());
		}
	...
	// 修改房間
	@PutMapping("/{roomId}")
	public ResponseEntity<ApiResponse<RoomDto>> updateRoom(@PathVariable Integer roomId, @RequestBody @Valid RoomDto roomDto, BindingResult bindingResult) {
		if(bindingResult.hasErrors()) {
